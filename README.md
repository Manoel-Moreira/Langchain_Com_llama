...
| Para verificar os dados do prompt | `/bye` |
| Instalar/baixar um modelo | `ollama pull <modelo>` |
| Listar modelos instalados | `ollama list` |
| Remover um modelo | `ollama rm <modelo>` |
| Ver informações do modelo | `ollama show <modelo>` |
| Criar modelo personalizado | `ollama create <nome> -f Modelfile` |
| Exportar modelo | `ollama export <modelo> > arquivo.olm` |
| Importar modelo | `ollama import arquivo.olm` |
| Parar o servidor do Ollama | `ollama stop` |
``
...
Caso necessário faça a leitura do material disponibilizado pela Hashtag treinamentos --> https://www.hashtagtreinamentos.com/uv-python
